...
SELECT
  ...
  '{"sourceTruthRequired":true,"humanReviewRequired":true,"singlePageFirst":true,"claimPolicy":"restricted-claims-require-approvedClaims","textPolicy":"visual_only","copyLayerMode":"deterministic_overlay"}'::jsonb,
  '{"purpose":"prove-template-set-selection-before-generation","validationStage":"single-page-first","aiStage":"visual-only","copyStage":"deterministic-overlay-after-ai"}'::jsonb,
  'aione-ai-assisted-design-template-set-v1'
