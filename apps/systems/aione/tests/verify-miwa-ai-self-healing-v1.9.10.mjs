...
must((system.includes('miwa-ai-layer.js?v=20260824-v1.9.10-miwa-ai-self-healing-layer-hotfix') || system.includes('miwa-ai-layer.js?v=20260824-v1.9.11-miwa-ai-runtime-chain-verification') || system.includes('v1.9.13-model-provider-layer') || system.includes('v1.9.16-ai-proposal-bridge') || system.includes('v1.9.17-ai-context-router') || system.includes('v1.9.28-ai-context-capabilities')), '系统入口未加载V1.9.10美和AI模块');
