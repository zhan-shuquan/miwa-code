...
assert.ok(masterCss.includes("--miwa-publication-aside-light:260px") && masterCss.includes("--miwa-publication-aside-standard:300px"), "publication aside widths missing");
assert.ok(masterCss.includes('data-page-mode="publication"'), "publication shell mode missing");
assert.ok(masterCss.includes("aspect-ratio:210/297") && masterCss.includes("@page{size:A4 portrait;margin:0}"), "V1.9.31.3 portrait publication geometry missing");
...
assert.ok(book.includes("miwa-publication-book") && book.includes("publicationPage"), "Business Home must consume publication master");
...
assert.ok(index.includes("miwa-publication-master.css?v=20260826-v1.9.31.3"), "publication master stylesheet not loaded");
...
console.log("V1.9.31.2 compatibility check passed under V1.9.31.3 superseding book master.");
