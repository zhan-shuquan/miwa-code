...
> **Current candidate: V1.9.34 WORK HOME CONTEXT + RECORDS UPGRADE CANDIDATE.**
V1.9.34继续把“后台复杂、前台简单”落实到真实页面：今日工作与我的关注共用同一轻量工作事项一览，全部工作才保留完整Work Browser；《美和工作手册》扩展为“方法论 + 按Sidebar顺序的逐页使用指南 + 操作演示”；工作记录新增本周/月/年与人员汇总/工作明细，以头像、负责/参与/闭环、事业、项目、流程呈现真实工作事实，并新增可供人才之家读取的人员工作汇总API。工作记录明确是事实层，不直接等于绩效评分。关注404增加Backend版本诊断能力，正式关注仍必须在Backend真实部署后完成持久化验收。

V1.9.33仍作为集团级工作之家结构基础：Sidebar、事业工作、公司透明读取、关注关系和统一Work Item均完整继承。
