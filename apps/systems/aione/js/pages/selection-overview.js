...
function page2(){return publicationPage({pageNumber:2,section:"第01章｜工作台定位",title:"打开选品工作台，先看全公司的商品机会",lead:"选品工作台默认页面就是商品机会一览。公共机会共享，员工可以按自己的时间主动参与选品。",content:`<div class="miwa-publication-editorial-grid cols-2"><article class="miwa-publication-editorial-card tone-green"><span>PUBLIC</span><h3>商品机会一览</h3><p>公司共享的商品机会池，用于发现、判断、关注和后续推进。</p></article><article class="miwa-publication-editorial-card tone-red"><span>PERSONAL</span><h3>我的选品</h3><p>员工开始选品和继续推进自己选品工作的主要入口。</p></article></div>`,conclusion:"公共机会共享，个人主动参与，正式结果统一沉淀。",bookLabel:"选品工作台",manualSection:"workbench"});}
...
function bookHtml(){
  ...
  const back=publicationBackCover({title:"关于《美和选品工作手册》",summary:"本手册用于明确选品工作台的定位、商品机会、我的选品、业务9要素和后续能力边界。",contents:["工作台定位","商品机会","我的选品","业务9要素","AI选品与产品开发","我的关注"],audiences:["公司全体成员","选品负责人","业务负责人","AI与自动化设计者"],bookLabel:"选品工作台",visualHtml:`<img src="${iconUrl}" alt="工作手册图标">`});
...
export async function initSelectionOverview(){
  ...
  document.title="美和AIONE一体化工作平台｜选品概览";
