...
import { initMiwaWorkHome } from "./pages/miwa-work-home.js?v=20260827-v1.9.32-work-home-v2-first-upgrade";
...
const WORK_HOME_ROUTES = new Set(["work","work-today","work-mine","work-all","work-blocked","work-review","work-records","work-pending","work-active","work-waiting","work-completed"]);
