...
export const ROUTE_REGISTRY = Object.freeze({
  ...
  "work-mine": route("work-mine", "我的工作", "platform", { status: "legacy", page: "./pages/work-home/template.html", parent: "work", nav:false }),
  ...
  "customer-home": route("customer-home", "客户之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  "supplier-home": route("supplier-home", "供应商之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  "talent-home": route("talent-home", "人才之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  "income-home": route("income-home", "收入之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  "expense-home": route("expense-home", "支出之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
