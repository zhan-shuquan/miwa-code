...
export const ROUTE_REGISTRY = Object.freeze({
  ...
  "application-home": route("application-home", "应用中心", "platform", { status: "active", page: "./pages/business-template/template.html", parent: "shared-home" }),
  ...
  "shared-home": route("shared-home", "共享之家", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  ...
  /* 共享之家：集团统一数字资源空间；知识之家负责规则与方法，共享之家负责可直接调用的资源本体。 */
  "standard-home": route("standard-home", "标准", "platform", { parent: "knowledge-home" }),
  "brand-home": route("brand-home", "品牌资产中心", "platform", { parent: "shared-home" }),
  "data-home": route("data-home", "数据中心", "platform", { parent: "shared-home" }),
  "knowledge-home": route("knowledge-home", "知识之家", "platform", { status: "active", page: "./pages/content-home/template.html" }),
  "code-assets": route("code-assets", "代码中心", "platform", { parent: "shared-home" }),
  "document-assets": route("document-assets", "文件中心", "platform", { parent: "shared-home" }),
  "software-home": route("software-home", "软件与账号", "platform", { parent: "application-home" }),
  "erp-home": route("erp-home", "ERP", "platform", { parent: "application-home" }),
