...
export const ROUTE_REGISTRY = Object.freeze({
  ...
  "application-home": route("application-home", "应用资源", "platform", { status: "active", page: "./pages/business-template/template.html", parent: "shared-resources" }),
  ...
  "shared-resources": route("shared-resources", "共享资源", "platform", { status: "active", page: "./pages/business-template/template.html" }),
  ...
  /* 商品之家：商品主数据を基点に店舖・SKU・資産・利益を接続する。 */
  ...
  /* 共享资源：后台管理与快捷资源注册空间，不属于11个一级之家。 */
  "standard-home": route("standard-home", "标准", "platform", { parent: "knowledge-home" }),
  "brand-home": route("brand-home", "品牌资产", "platform", { parent: "shared-resources" }),
  "data-home": route("data-home", "数据资产", "platform", { parent: "shared-resources" }),
  "knowledge-home": route("knowledge-home", "知识之家", "platform", { status: "active", page: "./pages/content-home/template.html" }),
  "code-assets": route("code-assets", "代码资产", "platform", { parent: "shared-resources" }),
  "document-assets": route("document-assets", "文件与资料资产", "platform", { parent: "shared-resources" }),
  "software-home": route("software-home", "软件与账号", "platform", { parent: "application-home" }),
  "erp-home": route("erp-home", "ERP", "platform", { parent: "shared-resources" }),
  ...
  "identity-home": route("identity-home", "身份与权限", "platform", { parent: "shared-resources" }),
  "contract-home": route("contract-home", "合同与法务", "platform", { parent: "shared-resources" }),
