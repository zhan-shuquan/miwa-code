...
export const ROUTE_REGISTRY = Object.freeze({
  ...
  "category-home": route("category-home", "分类中心", "platform", { status: "active", page: "./pages/business-home/template.html", parent: "product-home" }),
  ...
  "channel-home": route("channel-home", "渠道之家", "platform", { status: "active", page: "./pages/business-home/template.html" }),
  "store-home": route("store-home", "店铺中心", "platform", { status: "active", page: "./pages/business-home/template.html", parent: "channel-home" }),
  ...
  "finance-home": route("finance-home", "财务之家", "platform", { status: "active", page: "./pages/business-home/template.html" }),
