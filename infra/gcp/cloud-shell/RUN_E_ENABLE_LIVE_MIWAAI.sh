...
export AIONE_IMAGE_TAG="${AIONE_IMAGE_TAG:-v1.9.30.2}"
...
say "Build V1.9.30.2 backend image for Work attention realtime sync + Drive registry + Work execution + live 美和AI"
